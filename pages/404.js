    ...
    <div className='flex items-center justify-center py-12'>
      <div className='flex items-center justify-center mx-4 bg-white border rounded-lg md:w-2/3 '>
        <div className='flex flex-col items-center py-16 '>
          ...
          <button
            type='button'
            className='h-10 mx-4 text-base text-white bg-red-600 border rounded-md w-44 hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-opacity-50 focus:ring-indigo-800'
          >
            <a href='/'>Go Home</a>
          </button>
        </div>
