...
const FeaturedPostCard = ({ post }) => (
  <div className="relative overflow-hidden h-72">
    <div
      className="absolute inline-block w-full bg-center bg-no-repeat bg-cover border border-gray-100 rounded-lg h-72"
    ...
    <div className="absolute flex flex-col items-center justify-center w-full h-full p-4 rounded-lg">
      ...
      <div className="absolute flex items-center justify-center w-full overflow-hidden bottom-5">
        <Image
          unoptimized
