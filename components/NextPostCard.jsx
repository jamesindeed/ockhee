...
const NextPostCard = ({ post, position }) => (
  <>
    <div
      className="absolute inline-block w-full bg-center bg-no-repeat bg-cover border border-gray-200 rounded-lg h-72"
    ...
    {position === "LEFT" && (
      <div className="absolute p-2 text-center bg-indigo-400 rounded-full cursor-pointer arrow-btn bottom-5 left-4">
        <svg
    ...
    {position === "RIGHT" && (
      <div className="absolute p-2 text-center bg-indigo-400 rounded-full cursor-pointer arrow-btn bottom-5 right-4">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="w-6 w-full h-6 text-white"
          fill="none"
